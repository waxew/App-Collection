package com.asteam.appcollection.p52
...
/**
 * Rebuilt Kotlin application #52.
 * Original Dropbox source: dialog - custom - material - xml.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Animated Dialog Ui"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "رابط دیالوگ متریال قدیمی، بازسازی با Dialog استاندارد"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "dialog - custom - material - xml.txt"
