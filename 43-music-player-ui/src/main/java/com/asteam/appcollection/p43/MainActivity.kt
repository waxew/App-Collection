package com.asteam.appcollection.p43
...
/**
 * Rebuilt Kotlin application #43.
 * Original Dropbox source: music player - xml.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Music Player Ui"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "رابط کنترل پخش موسیقی"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "music player - xml.txt"
