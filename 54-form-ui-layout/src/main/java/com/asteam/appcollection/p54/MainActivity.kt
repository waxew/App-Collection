package com.asteam.appcollection.p54
...
/**
 * Rebuilt Kotlin application #54.
 * Original Dropbox source: save data send string - xml.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Form Ui Layout"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "رابط فرم نام و تلفن"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "save data send string - xml.txt"
