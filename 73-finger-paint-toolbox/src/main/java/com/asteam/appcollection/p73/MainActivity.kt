package com.asteam.appcollection.p73
...
/**
 * Rebuilt Kotlin application #73.
 * Original Dropbox source: جعبه ابزار - نقاشی.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Finger Paint Toolbox"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "نسخه فارسی نقاشی، بازسازی مستقل"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "جعبه ابزار - نقاشی.txt"
