package com.asteam.appcollection.p62
...
/**
 * Rebuilt Kotlin application #62.
 * Original Dropbox source: dialog - custom - 1.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Dialog Suite"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "مجموعه AlertDialog و Custom Dialog"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "dialog - custom - 1.txt"
