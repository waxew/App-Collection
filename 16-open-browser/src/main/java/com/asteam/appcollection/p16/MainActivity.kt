package com.asteam.appcollection.p16
...
/**
 * Rebuilt Kotlin application #16.
 * Original Dropbox source: browser.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Open Browser"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "باز کردن لینک در مرورگر امن"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "browser.txt"
