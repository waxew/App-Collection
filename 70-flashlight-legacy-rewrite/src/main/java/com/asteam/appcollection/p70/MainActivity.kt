package com.asteam.appcollection.p70
...
/**
 * Rebuilt Kotlin application #70.
 * Original Dropbox source: flash.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Flashlight Legacy Rewrite"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "نسخه تکراری چراغ قوه با API جدید"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "flash.txt"
