package com.asteam.appcollection.p39
...
/**
 * Rebuilt Kotlin application #39.
 * Original Dropbox source: save data send string - java.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Form Validation"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "فرم نام و تلفن با اعتبارسنجی"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "save data send string - java.txt"
