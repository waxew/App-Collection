package com.asteam.appcollection.p28
...
/**
 * Rebuilt Kotlin application #28.
 * Original Dropbox source: list view.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Simple List"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "لیست ساده قابل کلیک"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "list view.txt"
