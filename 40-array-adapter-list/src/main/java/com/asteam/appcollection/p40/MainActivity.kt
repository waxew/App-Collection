package com.asteam.appcollection.p40
...
/**
 * Rebuilt Kotlin application #40.
 * Original Dropbox source: listview - array adapter - java.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Array Adapter List"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "ArrayAdapter و ListView"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "listview - array adapter - java.txt"
