package com.asteam.appcollection.p30
...
/**
 * Rebuilt Kotlin application #30.
 * Original Dropbox source: RadioGroup.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Radio Group"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "RadioGroup و انتخاب یکتا"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "RadioGroup.txt"
