package com.asteam.appcollection.p25
...
/**
 * Rebuilt Kotlin application #25.
 * Original Dropbox source: Spinner.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Spinner Selector"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "انتخاب گزینه با Spinner"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "Spinner.txt"
