package com.asteam.appcollection.p76
...
/**
 * Rebuilt Kotlin application #76.
 * Original Dropbox source: جعبه ابزار - تاریخ.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Date Picker Toolbox"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "نسخه تکراری DatePicker، بازسازی"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "جعبه ابزار - تاریخ.txt"
