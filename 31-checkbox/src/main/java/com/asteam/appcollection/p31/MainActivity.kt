package com.asteam.appcollection.p31
...
/**
 * Rebuilt Kotlin application #31.
 * Original Dropbox source: checkBox.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Checkbox"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "CheckBox و انتخاب چندگانه"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "checkBox.txt"
