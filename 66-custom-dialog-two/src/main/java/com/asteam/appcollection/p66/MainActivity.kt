package com.asteam.appcollection.p66
...
/**
 * Rebuilt Kotlin application #66.
 * Original Dropbox source: dialog - custom2 - java.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Custom Dialog Two"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Custom Dialog نسخه ۲"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "dialog - custom2 - java.txt"
