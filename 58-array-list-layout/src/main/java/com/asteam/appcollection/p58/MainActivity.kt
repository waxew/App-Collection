package com.asteam.appcollection.p58
...
/**
 * Rebuilt Kotlin application #58.
 * Original Dropbox source: listview - array adapter - xml.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Array List Layout"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Layout لیست ArrayAdapter"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "listview - array adapter - xml.txt"
