package com.asteam.appcollection.p44
...
/**
 * Rebuilt Kotlin application #44.
 * Original Dropbox source: music player - manifest.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Audio Manifest Modern"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "آموزش تنظیمات Manifest برای پخش صوت"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "music player - manifest.txt"
