package com.asteam.appcollection.p75
...
/**
 * Rebuilt Kotlin application #75.
 * Original Dropbox source: جابجایی متن در تصویر.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Move Text Animation"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "نسخه فارسی حرکت متن، بازسازی مستقل"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "جابجایی متن در تصویر.txt"
