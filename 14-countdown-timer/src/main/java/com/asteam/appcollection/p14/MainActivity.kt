package com.asteam.appcollection.p14
...
/**
 * Rebuilt Kotlin application #14.
 * Original Dropbox source: جعبه ابزار - شمارنده معکوس.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Countdown Timer"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "شمارنده معکوس"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "جعبه ابزار - شمارنده معکوس.txt"
