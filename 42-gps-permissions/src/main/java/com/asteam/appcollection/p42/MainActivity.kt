package com.asteam.appcollection.p42
...
/**
 * Rebuilt Kotlin application #42.
 * Original Dropbox source: gps - manifest.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Gps Permissions"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "آموزش مجوزهای Location مدرن"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "gps - manifest.txt"
