package com.asteam.appcollection.p09
...
/**
 * Rebuilt Kotlin application #09.
 * Original Dropbox source: جعبه ابزار - نوتفیگیشن.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Notification Modern"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "اعلان استاندارد با NotificationChannel"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "جعبه ابزار - نوتفیگیشن.txt"
    ...
    private fun sendDemoNotification(title: String, text: String) {
        ...
        manager.notify(100 + 9, builder.build())
    }
}
