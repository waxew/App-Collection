package com.asteam.appcollection.p77
...
/**
 * Rebuilt Kotlin application #77.
 * Original Dropbox source: جعبه ابزار - ازسال ایمیل.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Send Email Toolbox"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "نسخه فارسی و تکراری ارسال ایمیل، بازسازی با Intent مدرن"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "جعبه ابزار - ازسال ایمیل.txt"
