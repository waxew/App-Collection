# 77 - Send Email Toolbox

- **فایل اصلی:** `جعبه ابزار - ازسال ایمیل.txt`
- **دسته:** تکراری / منسوخ بازسازی‌شده
- **بازسازی:** Kotlin + Android API 37
- **نسخه:** 1.0.0
- **هدف:** نسخه فارسی و تکراری ارسال ایمیل، بازسازی با Intent مدرن
...
افزودن قالب پیام، پیوست و مخاطبان اخیر
