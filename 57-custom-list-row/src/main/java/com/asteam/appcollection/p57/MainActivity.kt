package com.asteam.appcollection.p57
...
/**
 * Rebuilt Kotlin application #57.
 * Original Dropbox source: listView - custom - extra.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Custom List Row"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "ردیف سفارشی لیست"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "listView - custom - extra.txt"
