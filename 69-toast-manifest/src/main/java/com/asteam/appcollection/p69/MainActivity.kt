package com.asteam.appcollection.p69
...
/**
 * Rebuilt Kotlin application #69.
 * Original Dropbox source: toast - custom - manifest.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Toast Manifest"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Manifest Toast قدیمی"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "toast - custom - manifest.txt"
