# 53 - Dialog Dependency Migration

- **فایل اصلی:** `dialog - custom - material - gradle.txt`
- **دسته:** تکراری / منسوخ بازسازی‌شده
- **بازسازی:** Kotlin + Android API 37
- **نسخه:** 1.0.0
- **هدف:** جایگزینی dependency قدیمی NiftyDialog
...
نمایش راهنمای مهاجرت و نمونه داخلی بدون dependency
