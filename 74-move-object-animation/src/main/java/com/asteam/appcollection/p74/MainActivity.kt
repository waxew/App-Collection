package com.asteam.appcollection.p74
...
/**
 * Rebuilt Kotlin application #74.
 * Original Dropbox source: move object in screen.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Move Object Animation"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "TranslateAnimation قدیمی، بازنویسی با ViewPropertyAnimator"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "move object in screen.txt"
