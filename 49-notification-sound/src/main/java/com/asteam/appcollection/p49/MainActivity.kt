package com.asteam.appcollection.p49
...
/**
 * Rebuilt Kotlin application #49.
 * Original Dropbox source: notfigation - java.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Notification Sound"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Notification قدیمی با صدا، بازنویسی با Channel"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "notfigation - java.txt"
    ...
    private fun sendDemoNotification(title: String, text: String) {
        ...
        manager.notify(100 + 49, builder.build())
    }
}
