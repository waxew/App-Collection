package com.asteam.appcollection.p38
...
/**
 * Rebuilt Kotlin application #38.
 * Original Dropbox source: toast - custom - java.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Custom Toast"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "پیام Toast مدرن"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "toast - custom - java.txt"
