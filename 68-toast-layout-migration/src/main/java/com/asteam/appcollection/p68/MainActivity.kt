package com.asteam.appcollection.p68
...
/**
 * Rebuilt Kotlin application #68.
 * Original Dropbox source: toast - custom - xml.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Toast Layout Migration"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Layout Toast سفارشی قدیمی"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "toast - custom - xml.txt"
