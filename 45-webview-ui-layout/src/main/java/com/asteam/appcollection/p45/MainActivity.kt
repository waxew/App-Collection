package com.asteam.appcollection.p45
...
/**
 * Rebuilt Kotlin application #45.
 * Original Dropbox source: webview - xml.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Webview Ui Layout"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "رابط WebView با نوار آدرس"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "webview - xml.txt"
