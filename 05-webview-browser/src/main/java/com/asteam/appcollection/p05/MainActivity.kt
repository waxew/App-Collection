package com.asteam.appcollection.p05
...
/**
 * Rebuilt Kotlin application #05.
 * Original Dropbox source: webview - java.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Webview Browser"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "مرورگر داخلی WebView"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "webview - java.txt"
