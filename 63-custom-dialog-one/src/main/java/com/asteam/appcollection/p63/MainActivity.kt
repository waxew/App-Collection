package com.asteam.appcollection.p63
...
/**
 * Rebuilt Kotlin application #63.
 * Original Dropbox source: dialog - custom1 - java.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Custom Dialog One"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Custom Dialog نسخه ۱"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "dialog - custom1 - java.txt"
