package com.asteam.appcollection.p60
...
/**
 * Rebuilt Kotlin application #60.
 * Original Dropbox source: listAcrivity - array adapter - java.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Listactivity Modern"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "جایگزینی ListActivity منسوخ با Activity + ListView"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "listAcrivity - array adapter - java.txt"
