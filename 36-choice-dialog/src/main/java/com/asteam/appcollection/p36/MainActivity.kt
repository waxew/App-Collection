package com.asteam.appcollection.p36
...
/**
 * Rebuilt Kotlin application #36.
 * Original Dropbox source: جعبه ابزار - دیالوگ.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Choice Dialog"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "دیالوگ انتخاب تک‌گزینه‌ای"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "جعبه ابزار - دیالوگ.txt"
