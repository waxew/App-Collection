package com.asteam.appcollection.p50
...
/**
 * Rebuilt Kotlin application #50.
 * Original Dropbox source: notfigation - xml.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Notification Ui"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "رابط ساخت اعلان"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "notfigation - xml.txt"
    ...
    private fun sendDemoNotification(title: String, text: String) {
        ...
        manager.notify(100 + 50, builder.build())
    }
}
