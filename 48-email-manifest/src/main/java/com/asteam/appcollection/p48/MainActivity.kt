package com.asteam.appcollection.p48
...
/**
 * Rebuilt Kotlin application #48.
 * Original Dropbox source: send mail - manifest.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Email Manifest"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "آموزش Intent و Manifest ایمیل"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "send mail - manifest.txt"
