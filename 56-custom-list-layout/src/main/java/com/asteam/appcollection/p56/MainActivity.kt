package com.asteam.appcollection.p56
...
/**
 * Rebuilt Kotlin application #56.
 * Original Dropbox source: listView - custom - xml.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Custom List Layout"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Layout لیست سفارشی"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "listView - custom - xml.txt"
