package com.asteam.appcollection.p15
...
/**
 * Rebuilt Kotlin application #15.
 * Original Dropbox source: currentDateTime.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Date Time"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "نمایش تاریخ و ساعت جاری"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "currentDateTime.txt"
