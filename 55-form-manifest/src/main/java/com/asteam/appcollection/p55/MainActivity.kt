package com.asteam.appcollection.p55
...
/**
 * Rebuilt Kotlin application #55.
 * Original Dropbox source: save data send string - manifest.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Form Manifest"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Manifest نمونه فرم"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "save data send string - manifest.txt"
