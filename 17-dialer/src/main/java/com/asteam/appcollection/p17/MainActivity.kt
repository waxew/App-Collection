package com.asteam.appcollection.p17
...
/**
 * Rebuilt Kotlin application #17.
 * Original Dropbox source: dailpad.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Dialer"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "باز کردن شماره‌گیر با شماره"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "dailpad.txt"
