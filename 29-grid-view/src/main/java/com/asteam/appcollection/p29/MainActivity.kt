package com.asteam.appcollection.p29
...
/**
 * Rebuilt Kotlin application #29.
 * Original Dropbox source: gridview1.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Grid View"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "نمایش GridView"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "gridview1.txt"
