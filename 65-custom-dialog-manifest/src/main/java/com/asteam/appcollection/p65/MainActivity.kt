package com.asteam.appcollection.p65
...
/**
 * Rebuilt Kotlin application #65.
 * Original Dropbox source: dialog - custom1 -manifest.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Custom Dialog Manifest"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Manifest دیالوگ نسخه ۱"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "dialog - custom1 -manifest.txt"
