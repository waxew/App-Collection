package com.asteam.appcollection.p61
...
/**
 * Rebuilt Kotlin application #61.
 * Original Dropbox source: listAcrivity - array adapter - manifest.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Listactivity Manifest"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Manifest ListActivity قدیمی، بازسازی استاندارد"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "listAcrivity - array adapter - manifest.txt"
