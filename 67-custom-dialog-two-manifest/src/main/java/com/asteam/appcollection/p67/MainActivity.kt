package com.asteam.appcollection.p67
...
/**
 * Rebuilt Kotlin application #67.
 * Original Dropbox source: dialog - custom2 - manifest.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Custom Dialog Two Manifest"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "Manifest دیالوگ نسخه ۲"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "dialog - custom2 - manifest.txt"
