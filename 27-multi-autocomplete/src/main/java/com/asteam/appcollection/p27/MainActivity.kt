package com.asteam.appcollection.p27
...
/**
 * Rebuilt Kotlin application #27.
 * Original Dropbox source: autoCompletCodeMulti.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Multi Autocomplete"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "MultiAutoCompleteTextView"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "autoCompletCodeMulti.txt"
