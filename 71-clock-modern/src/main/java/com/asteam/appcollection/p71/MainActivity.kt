package com.asteam.appcollection.p71
...
/**
 * Rebuilt Kotlin application #71.
 * Original Dropbox source: clock.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Clock Modern"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "ساعت دیجیتال/آنالوگ قدیمی، بازسازی"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "clock.txt"
