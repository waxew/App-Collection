package com.asteam.appcollection.p37
...
/**
 * Rebuilt Kotlin application #37.
 * Original Dropbox source: dialog - custom - material - java.txt
...
class MainActivity : BaseDemoActivity() {
    ...
    override val demoTitle: String = "Animated Dialog"

    /** Short user-facing explanation of the rebuilt sample. */
    override val demoDescription: String = "دیالوگ انیمیشنی بدون کتابخانه قدیمی"

    /** Keeps traceability to the original 2017 text file. */
    override val sourceReference: String = "dialog - custom - material - java.txt"
